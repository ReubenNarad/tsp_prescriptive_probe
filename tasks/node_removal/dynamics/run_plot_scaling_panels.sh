...
CONFIG="tasks/node_removal/tmp/scale_dynamics/scale_dynamics_config.json"
OUT_PATH="tasks/node_removal/tmp/scale_dynamics/train_vs_probe.png"
PROBE_METRIC="top1_acc"
SMOOTH_TRAIN=11
SMOOTH_PROBE=5
COLORMAP="viridis"
TRAIN_TITLE="TSP policy performance"
PROBE_TITLE="Probe performance as policy trains"
...
OVERRIDES_JSON='{
  "3.10M": {"stretch": 1.0, "downsample_train": 1, "downsample_probe": 2},
  "0.44M": {"stretch": 1.0, "downsample_train": 1, "downsample_probe": 2},
  "0.20M": {"stretch": 6.0, "downsample_train": 1, "downsample_probe": 1}
}'

RESOLVED_CONFIG="tasks/node_removal/tmp/scale_dynamics/scale_dynamics_config_resolved.json"
